...
public class DbInitializer : IDbInitializer
{
    ...
    private void SeedRoles()
    {
        ...
        {
            Name = RoleConstants.SUPER_ADMIN_ROLE
        })
            .GetAwaiter()
            .GetResult();
    ...
    {
        var superAdmin = _userManager.GetUsersInRoleAsync(RoleConstants.SUPER_ADMIN_ROLE).GetAwaiter().GetResult();
        ...
        _userManager.AddToRoleAsync(user, RoleConstants.SUPER_ADMIN_ROLE)
            .GetAwaiter()
            .GetResult();
    }
}
